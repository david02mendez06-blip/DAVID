  ...
  return (
    ...
    >
      <section className="px-5 pt-10 pb-6">
        ...
        <h2 className="text-3xl font-extrabold text-white leading-tight mb-3">Catálogo de Soluciones</h2>
      ...
      <div className="px-5 py-4">
        <div className="flex items-center justify-between mb-3">
          <h3 className="text-xs font-bold text-slate-500 uppercase tracking-widest">Filtrar por Industria</h3>
        </div>
      ...
      <section className="px-5 py-2 grid grid-cols-1 gap-6">
        {products.map((p) => (
          <div key={p.id} className="bg-slate-900 rounded-3xl overflow-hidden border border-white/5 shadow-xl">
